#!/usr/bin/env python3
"""组装豆包看板 latest.json（与 qianwen-refresh/assemble.py 同构，窗口起点 2026-08-28）：模板(上一版) + q1..q4 原始数 → 发布快照。
...
PROFILE_DIMS = ["asset_holding_status", "asset_bucket", "asset_at_bind_status",
                "holding_lifecycle_status", "lifetime_investment_status",
...
BUCKET_ORDER = {
    ...
    "holding_lifecycle_status": ["no_first_investment", "churned", "under_management"],
...
BUCKET_LABELS = {"100k_1m": "10—100 万元", "gte_1m": "100 万元以上",
                 ...
                 "no_first_investment": "无首投（从未买入）", "churned": "已流失（投过已清零）",
                 "under_management": "在管（当前有资产）",
...
DEFAULT_BUCKET = {"asset_holding_status": "unknown", "asset_bucket": "unknown",
                  ...
                  "holding_lifecycle_status": "no_first_investment",
