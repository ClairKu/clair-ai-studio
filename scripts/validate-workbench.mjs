...
const requiredSignals = [
  ...
  [styleSource, ".bucket-drag-preview", "分类拖动缺少可见预览"],
  ...
  [appSource, 'data-action="clear-archive"', "归档区缺少一键清空入口"],
  [appSource, 'type: "clear-archive"', "一键清空归档缺少二次确认弹窗"],
  [appSource, 'commitReportDispositions(archivedReports, "deleted")', "一键清空没有为全部归档成果写入删除墓碑"],
  [styleSource, ".archive-clear-button", "归档区一键清空按钮缺少明确危险操作样式"],
  ...
  [appSource, 'WORKSPACE_ACCESS_SESSION_KEY = "clair-ai-studio-access-v1"', "新页面打开未携带工作台会话通行证"],
  [appSource, "nextWindow.sessionStorage.setItem(", "新页面打开未写入工作台会话通行证"],
  [appSource, "nextWindow.opener = null", "新页面打开未隔离 opener"],
  [appSource, "function workbenchReaderUrl(value)", "工作台内嵌阅读缺少免密地址标记"],
  [appSource, 'target.searchParams.set(WORKBENCH_EMBED_PARAMETER, "1")', "工作台内嵌阅读未写入免密标记"],
  [appSource, 'src="${escapeHtml(workbenchReaderUrl(report.url))}"', "工作台成果阅读页未使用免密地址"],
