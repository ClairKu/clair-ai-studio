...
const schemaVersion = "qianwen-user-acquisition-v5";
...
function validateAudienceData() {
  ...
  if (data.behavior?.window_start_at !== launchAt || data.behavior?.window_end_at !== data.meta.data_cutoff || data.behavior?.anchor !== "first_bound_at") {
