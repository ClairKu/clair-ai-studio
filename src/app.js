  ...
  reports: [
    {
      ...
      modifiedAt: "2026-08-12T19:20:00.000+08:00",
      source: "佳静去重版 296 条为内容母表，不去重版 1,478 条用于补来源和追溯｜最终 285 个独立内容：263 篇文章、22 条视频｜采用阅读量 4,367,850：2 条公开页最新值、283 条佳静表格回退｜13 个阅读破万内容全部可点击｜动态汇总、筛选搜索排序、阅读来源标注与 CSV 导出｜公开脱敏版",
      access: "production",
      workType: "data-analysis",
      tags: ["盈米基金", "且慢小顾", "阿里千问", "舆情分析", "传播分析", "内容去重", "最新阅读", "破万链接", "视频传播", "企微补充", "数据看板", "筛选汇总", "CLAIR", "HTML", "脱敏", "生产"],
    },
    {
