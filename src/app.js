...
const initialState = {
  ...
  reports: [
    ...
    },
    {
      ...
      source: "神策 qiemanproduction 全量埋点（2026-07-17 内测起点 ~ 09-10）+ 生产 TiDB 身份核验｜盈米本体下钻 68 轮｜去重用户 37 人（6 实名 + 31 匿名，内含 3 个内部/官方账号）｜落地 2,882 次 × 原子接口调用 3,783 次，TOP2 账号占 61%｜自然用户 3 人：调用前行为画像 + 落地页路径｜转化：注册/开户/绑卡均为 0，1 例交易转化（黄** 首用次日资产大重组：长赢跟车 + 7 策略转出 + 定投），定性为存量重组非拉新",
      access: "production",
      workType: "data-analysis",
