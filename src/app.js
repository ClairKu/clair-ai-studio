  ...
  reports: [
    {
      ...
      source: "盈米本体 × 生产数仓只读聚合｜数据截至 2026-08-17 10:32（北京时间）｜1,065 个成功映射账号：756 个接入后新注册、309 个绑定既有账号｜8 天首次映射趋势、去重与关联完整性审计、指标口径边界｜公开脱敏聚合，不含账号明细与数据库凭证",
      access: "production",
      workType: "data-analysis",
      tags: ["千问", "且慢", "AI 小顾", "账号映射", "用户增长", "数据分析", "数据看板", "本体", "生产数据", "指标口径", "公开脱敏", "HTML", "生产"],
    },
    {
