...
const initialState = {
  ...
  reports: [
    ...
    },
    {
      ...
      source: "OAP OAuth 授权 × 且慢生产数仓只读聚合｜数据截至 2026-09-05 22:05（北京时间）｜累计且当前有效绑定 341 人，其中绑定时新注册 194 人、绑定前已有且慢账号 147 人；91 人发生过重新授权，当前无完全解绑用户｜且慢券商 0008 口径下 30 人持有约 434.49 万元，11 人绑定后有非钱包买入，但绑定后首投为 0；经营价值全部来自老用户｜OAuth 调用缺少用户级回连，绑定人数不替代 AI 小顾使用人数｜仅公开聚合统计，不含用户身份、凭证或原始对话",
      access: "production",
      workType: "data-analysis",
