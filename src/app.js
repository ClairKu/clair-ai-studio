...
const initialState = {
  ...
  reports: [
    ...
    },
    {
      ...
      source: "盈米本体 × 生产数据库｜数据截至 2026-09-18 18:05（北京时间），资产为 2026-09-18 完整快照｜绑定 = 完成豆包 OAuth 授权且当前仍有效；新老口径按每个用户首次授权当刻是否新注册判定：上架三周累计绑定用户 1,114，其中绑定时新注册 754、绑定时已有账户 360｜与千问看板同一页面、同一口径：分客群关键转化（全部 / 新投 / 首投 / 再投 / 新户 / 新户首投 / 老用户 / 老户唤回 / 老户首投）、累计与每日新增分栏走势、在且慢的经营情况与用户画像｜全部绑定用户当前保有 2,064.5 万元（93 人，含绑定前已有资产），绑定后入金 17.7 万元（33 人 / 83 笔）、绑定后买入 36.6 万元（51 人），绑定后新开户 3 人、新做风测 4 人，暂无人生首投｜1,057 人绑定后产生豆包会话令牌（94.9%），以此作为有效使用的代理口径｜只公开统计结果，不含用户身份标识与原始对话",
      access: "production",
      workType: "data-analysis",
