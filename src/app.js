...
const initialState = {
  ...
  reports: [
    ...
    },
    {
      ...
      source: "31 项官方原始来源｜UK DDaT、SFIA 9、美国 OPM/NIST、Google、Microsoft、Amazon、Apple、Stripe、Uber、OpenAI、Anthropic、百度、京东、字节、腾讯、Capital One、JPMorgan Chase、BlackRock、招商银行、工商银行及中美欧监管材料｜附 DDaT 四级技能成熟度、五级产品岗位与 SFIA L2–L6 官方定义中文译述｜建立 6 级产品骨架、9 维通用能力、9 维 AI 叠加、金融 7 道硬门槛、招聘晋升证据包与 12 周落地路线｜公开资料研究，不声称公司未公开内部职级",
      access: "production",
      workType: "research",
      tags: ["产品经理", "AI 产品经理", "职级体系", "任职资格", "能力模型", "人才盘点", "晋升", "招聘", "金融科技", "AI 治理", "深度研究", "中文译述", "HTML", "生产"],
    },
    {
