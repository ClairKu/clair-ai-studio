...
const initialState = {
  ...
  reports: [
    ...
    },
    {
      ...
      source: "盈米本体 × 生产数据库｜数据截至 2026-08-17 15:45（北京时间）｜服务上线以来累计绑定用户 1,088：其中新用户 772、老用户 316｜新增用户画像与行为：当前有资产 151、历史投资 169、绑定后发起投资 60｜支持新老用户切换、一键更新与明细联动｜画像与行为中的 20 人以下分组隐藏，不含用户明细、单用户金额或原始对话",
      access: "production",
      workType: "data-analysis",
      tags: ["千问", "且慢", "AI 小顾", "千问引流", "用户增长", "用户画像", "用户行为", "新用户", "老用户", "用户资产", "首次投资", "投资行为", "小顾使用", "每日增量", "交互分析", "数据明细", "数据看板", "本体", "生产数据", "HTML", "生产"],
    },
    {
