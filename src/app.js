  ...
  reports: [
    {
      ...
      modifiedAt: "2026-08-12T18:38:00.000+08:00",
      source: "媒体监测不去重导出 1,478 条 + 1 条企微来源补录｜1,451 篇文章、28 条视频、5,590,563 阅读量下限｜20 条阅读破万内容已补可点击入口｜动态汇总、筛选搜索排序、明细与 CSV 导出｜公开脱敏版",
      access: "production",
      workType: "data-analysis",
      tags: ["盈米基金", "且慢小顾", "阿里千问", "舆情分析", "传播分析", "破万链接", "视频传播", "企微补充", "数据看板", "筛选汇总", "CLAIR", "HTML", "脱敏", "生产"],
    },
    {
