...
const initialState = {
  ...
  reports: [
    ...
    },
    {
      ...
      groupId: "ai-platform",
      title: "盈米 AI 开放平台｜项目汇报 2026·08（口令版）",
      ...
      source: "项目进展 → 产品规划 → 往外看竞品 → 向内看问题｜含商务定价 · 口令访问",
      access: "production",
      workType: "reporting",
      tags: ["AI 开放平台", "OAP", "项目汇报", "渠道上新", "商业化", "竞品分析", "加密", "HTML", "生产"],
    },
    {
    ...
    },
    {
      ...
      source: "系统关系图 × 服务关系图｜AI 开放平台置底 · 自下而上统一架构",
      access: "production",
