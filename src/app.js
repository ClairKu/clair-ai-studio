...
const initialState = {
  ...
  reports: [
    ...
    },
    {
      ...
      source: "且慢上线以来经营走势两图整合（公司/且慢/启明三维度）｜规模走势（颜色=维度、实线=基金保有、虚线=基金投顾：公司 608.35 亿/531.63 亿、且慢 363.71 亿/324.53 亿、启明 243.08 亿/205.27 亿，月度 2021-07 起；且慢自助/组合构成与综合 AUM 半年锚点可开启，悬停附自助占比 5.7%→8.0%）｜用户走势（投顾签约 53.9 万 / 有资产 42.4 万 / 在管 29.5 万 / 有交易月度 2016-06 起全历史）｜公司=stat 表 broker=# 汇总行，启明=171 个 TAMP 投顾团队 broker（排且慢/蜂鸟）｜图例勾选切换 + 全局时间范围 + 十字线悬停 + 表格视图｜官方且慢蓝 #1B88EE 家族｜生产数仓 dw-tidb（redash ds41/ds31）盈米本体查询｜自绘 SVG 零依赖单文件｜CLAIR 可视化 HTML",
      access: "production",
      workType: "data-analysis",
