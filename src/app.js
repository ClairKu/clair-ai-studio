...
const initialState = {
  ...
  reports: [
    ...
    },
    {
      ...
      source: "封面＋目录＋19 屏完整实践报告｜战略问题—小顾价值验证—两支公开强脱敏完整录屏—经验总结—能力下沉—微信/千问超级入口—六种合作模式—502 日 OAP 增长—NEXT｜纠正“导出已完成”与“1478 篇报道”口径，缺失新增与转化显式待补",
      access: "production",
      workType: "reporting",
      tags: ["且慢", "AI 小顾", "AI 开放平台", "OAP", "千问", "微信", "增长", "产品实践", "完整录屏", "公开脱敏", "证据治理", "CLAIR", "HTML", "生产"],
    },
    {
