...
const initialState = {
  ...
  reports: [
    ...
    },
    {
      ...
      groupId: "xiaogu",
      title: "且慢经营走势｜规模与用户（公司/蜂鸟/且慢/启明）",
      ...
      source: "且慢上线以来经营走势两图整合（公司/蜂鸟/且慢/启明四维度全口径修正版）｜规模走势实线=全口径 AUM（dwd combine ROOT 综合资产含在途/钱包：公司 2757.07 亿 / 蜂鸟机构直连 1970.15 亿 / 且慢 408.41 亿 / 启明 TAMP 378.52 亿，月度 2021-07 起 62 个月，锚点与配方①一致）｜虚线=柜台清算口径投顾组合保有（公司 531.63 / 且慢 324.53 / 启明 205.27 亿），柜台口径不含蜂鸟直连与启明转托管，口径差异页内注明｜且慢柜台保有/自助/组合灰色开关，悬停附自助占比｜用户走势（签约 53.9 万 / 有资产 42.4 万 / 在管 29.5 万 / 有交易月度全历史）｜图例勾选切换 + 时间范围 + 十字线 + 表格｜官方且慢蓝 #1B88EE 家族｜生产数仓 dw-tidb（redash ds41/ds31）盈米本体查询与口径核对｜自绘 SVG 零依赖单文件｜CLAIR 可视化 HTML",
      access: "production",
      workType: "data-analysis",
