  ...
  reports: [
    {
      ...
      groupId: "ai-platform",
      title: "五端 AI Token 月度盘点｜明细 · 走势 · 性价比",
      ...
      source: "本机会话明细 + Cursor 官方计量只读盘点｜2026-08-10 00:00 至 2026-09-10 17:55（Asia/Shanghai）｜五端总处理量 33.391 亿 token，非缓存输入 + 输出 1.595 亿｜Cursor 已补齐 4.709 亿 token，Ultra $200/月，同期官方模型标价等价 $487.31，逐日记录均为 included（不是额外扣费）｜含逐日堆叠、累计走势、模型明细、套餐性价比、数据索引与自检｜公开脱敏，不含账号、密钥、会话正文、个人路径与任务内容",
      access: "production",
