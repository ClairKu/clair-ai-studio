  ...
  reports: [
    {
      ...
      source: "佳静两版媒体监测表 × 今日头条公开信息流 × 5 段用户提供录屏｜257 个独立内容、235 篇文章、22 条视频｜表内阅读 3,274,357、公开展现 448,514，阅读/展现/播放不混加｜5 个经典案例可直接播放｜公开脱敏版",
      access: "production",
    ...
    },
    {
      ...
      groupId: "xiaogu",
      title: "且慢小顾生产卡片服务图谱｜35 注册、23 独立落卡",
      ...
      modifiedAt: "2026-08-13T11:32:00.000+08:00",
      source: "且慢小顾生产前端 CARD_REGISTRY × 两轮登录态生产对话交叉测试｜35 个注册业务组件、23 个真实独立落卡、5 个降级呈现、7 个未独立落卡｜37 条推荐问法、20 个快捷服务、6 类场景与 35 项完整触发清单｜公开基金/市场截图；账户信息脱敏",
      access: "production",
    ...
    },
    {
      ...
      groupId: "ai-platform",
      title: "且慢怎么快起来、怎么破圈？｜15 分钟 AI 实践分享",
      ...
      source: "三无一强 × 入口迁移 × 小顾做深存量 × 开放平台打开增量｜含 15 分钟逐页讲稿、系统架构、千问分发与证据边界",
      access: "production",
      workType: "reporting",
      tags: ["且慢", "AI 小顾", "AI 开放平台", "OAP", "15 分钟分享", "千问", "增长", "产品实践", "系统架构", "CLAIR", "HTML", "生产"],
    },
    {
