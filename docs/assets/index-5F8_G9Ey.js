(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const c of n.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&a(c)}).observe(document,{childList:!0,subtree:!0});function i(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function a(r){if(r.ep)return;r.ep=!0;const n=i(r);fetch(r.href,n)}})();const Dt="clair-ai-studio-tasks-v1",re=[{id:"save",name:"保存",hint:"自动识别并进入成果库"},{id:"decision",name:"决策",hint:"发起决策推演"},{id:"review",name:"评审",hint:"自动匹配合适的评审 Skill"}],Pt={save:`
    ...
    </svg>`},V=[{id:"requirement",name:"需求评审"},{id:"solution",name:"方案评审"},{id:"decision",name:"决策推演"},{id:"agreement",name:"协议审查"},{id:"career",name:"履历评估"}];let I=dt();function dt(){return{material:"",files:[]}}function Rt(){var t;return((t=crypto.randomUUID)==null?void 0:t.call(crypto))||`${Date.now()}-${Math.random()}`}function ne(t){var r;const e=t.toLowerCase(),a=((r=[["agreement",["协议","合同","条款","保密","签署","数据处理"]],["career",["简历","履历","候选人","晋升","岗位","面试"]],["decision",["决策","选型","取舍","是否推进","选择"]],["requirement",["需求","prd","用户故事","验收","原型"]],["solution",["方案","流程","架构","设计","上线"]]].find(([,n])=>n.some(c=>e.includes(c))))==null?void 0:r[0])||"solution";return V.find(n=>n.id===a)||V[1]}function oe(t){return t<1024?`${t} B`:t<1024*1024?`${Math.ceil(t/1024)} KB`:`${(t/1024/1024).toFixed(1)} MB`}async function H(t){const e=[...t].slice(0,20);return Promise.all(e.map(async i=>{const a=i.type.startsWith("text/")||/\.(md|txt|csv|json|html|xml)$/i.test(i.name);let r="";if(a&&i.size<=1024*1024)try{r=(await i.text()).slice(0,12e3)}catch{r=""}return{id:Rt(),name:i.name,type:i.type||"文件",size:i.size,sizeLabel:oe(i.size),excerpt:r}}))}function se(t){return I.files.length?`<div class="attachment-list">${I.files.map(e=>`
...
${i.documentElement.outerHTML}`}function qe(t){if(!o.hasDraft||!o.draftHtml)throw new Error("请先暂存当前修订，再另开预览");const e=new Blob([Ee(o.draftHtml,t.url)],{type:"text/html;charset=utf-8"}),i=URL.createObjectURL(e),a=window.open(i,"_blank");if(!a)throw URL.revokeObjectURL(i),new Error("浏览器拦截了新窗口，请允许弹窗后重试");a.opener=null,window.setTimeout(()=>URL.revokeObjectURL(i),6e4)}async function pt(t,{silent:e=!1}={}){var n;const i=await wt(),a=await vt(i),r=new Date().toISOString();try{sessionStorage.setItem(bt(t.id),JSON.stringify({reportId:t.id,reportUrl:t.url,savedAt:r,baseFiles:ut(),html:a}))}catch{throw new Error("浏览器暂存空间不足，请先下载 HTML 备份")}return o.html=i,o.draftHtml=i,o.draftAt=r,o.hasDraft=!0,o.dirty=!1,o.lastCommit="",Y(),e||(n=o.showToast)==null||n.call(o,"已暂存在当前浏览器会话，尚未更新 GitHub"),i}async function xe(t){var s,d;const e=o.target;if(!(e!=null&&e.owner)||!e.repository||!e.path||!e.branch)throw new Error("请先填写 GitHub 仓库、分支和 HTML 路径");if(!o.token)throw new Error("请先提供 GitHub Fine-grained Token");const i=await vt(t),a=(e.mirrors||[]).map(l=>l.path),r=ft([...a.filter(l=>l.startsWith("public/")),...a.filter(l=>!l.startsWith("public/")&&l!==e.path),e.path]);let n="";const c=[];for(const l of r)try{const p=l.split("/").map(encodeURIComponent).join("/"),u=`/repos/${encodeURIComponent(e.owner)}/${encodeURIComponent(e.repository)}/contents/${p}`,m=await J(`${u}?ref=${encodeURIComponent(e.branch)}`,{token:o.token}),y=ut(e)[l];if(y&&m.sha!==y)throw new Error(`生产文件 ${l} 已在本次编辑后更新，请重新打开报告合并修改`);const k=await J(u,{token:o.token,method:"PUT",body:{message:`Update ${o.reportTitle} from Clair's Studio`,content:we(i),sha:m.sha,branch:e.branch}});n=((s=k==null?void 0:k.commit)==null?void 0:s.sha)||n,e.baseFiles={...ut(e),[l]:((d=k==null?void 0:k.content)==null?void 0:d.sha)||m.sha},c.push(l)}catch(p){throw c.length?new Error(`已更新 ${c.join("、")}，但 ${l} 同步失败：${p.message}`):p}return{commit:n,files:c.length}}async function qt(t){var e,i;if(!o.saving){o.saving=!0,Y();try{const a=o.dirty?await pt(t,{silent:!0}):o.draftHtml||await wt(),r=await xe(a);o.html=a,o.dirty=!1,o.hasDraft=!1,o.draftHtml="",o.draftAt="",o.lastCommit=r.commit,Bt(t.id),(e=o.showToast)==null||e.call(o,r.files>1?`已同步 ${r.files} 个 GitHub 文件，Pages 正在更新`:"已提交 GitHub，Pages 正在更新")}catch(a){(i=o.showToast)==null||i.call(o,(a==null?void 0:a.message)||"保存失败，请下载 HTML 备份")}finally{o.saving=!1,Y()}}}function Le(t){const e=o.target||{owner:"ClairKu",repository:"",branch:"main",path:""};return`
    ...
    </div>`}function xt({pendingSave:t=!1}={}){o.settingsOpen=!0,o.pendingSave=t;const e=document.querySelector(".editor-settings-backdrop");if(!e)return;e.hidden=!1;const i=e.querySelector("#editor-settings-form"),a=o.target||{};if(i){i.elements.owner.value=a.owner||"ClairKu",i.elements.repository.value=a.repository||"",i.elements.branch.value=a.branch||"main",i.elements.path.value=a.path||"";const r=i.querySelector('button[type="submit"]');r&&(r.textContent=t?"连接并保存":"保存设置")}}function G(){o.settingsOpen=!1,o.pendingSave=!1;const t=document.querySelector(".editor-settings-backdrop");t&&(t.hidden=!0)}function Me(){o.publishConfirmOpen=!0;const t=document.querySelector(".editor-publish-backdrop");t&&(t.hidden=!1)}function z(){o.publishConfirmOpen=!1;const t=document.querySelector(".editor-publish-backdrop");t&&(t.hidden=!0)}function Gt(t=""){return!!(o.reportId&&(!t||o.reportId===t))}function De(t,{render:e,showToast:i}){jt(),Object.assign(o,{reportId:t.id,reportTitle:t.title,reportUrl:t.url,status:"loading",render:e,showToast:i}),e(),o.loadPromise=Nt(t)}function Pe(t,e){var l;const i=o.target?`${o.target.owner}/${o.target.repository} · ${o.target.path}${(l=o.target.mirrors)!=null&&l.length?` · 同步 ${o.target.mirrors.length+1} 处`:""}`:"尚未识别 GitHub 源文件",a=Ht(),r=o.status==="ready"?`
      ...
      <header class="reader-header editor-header compact-reader-header compact-editor-header">
        ...
        <div class="reader-actions editor-actions compact-reader-actions compact-editor-actions" aria-label="编辑操作">
          ...
          <button class="reader-icon-button publish-icon-action${o.saving?" is-saving":""}" type="button"
            data-editor-action="publish" aria-label="${d}" title="${d}"
    ...
    <article class="report-card ${a?"restricted-card":""} ${e?"archived-card":""} ${D===t.id?"is-move-selected":""}" data-report-id="${h(t.id)}">
      <button class="card-main" type="button" data-action="open" data-id="${h(t.id)}" aria-label="打开${h(t.title)}">
        ...
        <span class="report-copy">
          ...
          ${(t.tags||[]).length?`<span class="report-tags">${t.tags.slice(0,3).map(s=>`<span>${h(s)}</span>`).join("")}</span>`:""}
          ${a?`<span class="report-access-note">${h(r)}</span>`:""}
        </span>
      </button>
      ${e?"":`
        <span class="report-drag-handle" role="button" tabindex="0" data-report-drag-id="${h(t.id)}"
          aria-label="拖动《${h(t.title)}》到其他${j()}" title="拖动到其他${j()}">
    ...
    </article>`}function At(){var i;if(!$)return"";if($.type==="tags"){const a=f.reports.find(r=>r.id===$.reportId);return a?`
      <div class="dialog-backdrop">
        <form class="dialog compact-dialog tag-dialog" id="tag-form">
          ...
          <div class="tag-suggestions">
            ${K.map(r=>`<button type="button" class="${(a.tags||[]).includes(r)?"selected":""}" data-tag-suggestion="${h(r)}">${h(r)}</button>`).join("")}
          </div>
          <div class="dialog-actions">
    ...
    <div class="dialog-backdrop">
      <form class="dialog" id="report-form">
        ...
        <label>放入分组
          <select name="groupId">
            ${f.groups.map(a=>`<option value="${h(a.id)}" ${a.id===e?"selected":""}>${h(a.name)}</option>`).join("")}
          </select>
        </label>
        <label>工作类型
          <select name="workType">
            ${tt.map(a=>`<option value="${h(a.id)}" ${a.id===((t==null?void 0:t.workType)||"product-planning")?"selected":""}>${h(a.name)}</option>`).join("")}
          </select>
        </label>
        <label>关键标签
    ...
    </main>`}function Je(t){var s;if(Gt(t.id))return Pe(t,h);const e=!t.url&&(!!t.savedContent||!!(t.savedFiles||[]).length),i=["org","account"].includes(t.access),a=t.loginProvider||((s=Yt(t.url))==null?void 0:s.provider)||(t.access==="org"?"组织帐号":"站点帐号"),r=t.savedHtml||it(t.savedContent,t.savedFiles),n=t.url?i?"edit":"edit-document":"",c=r?`
...
`,"<br />")}</div>`:""}
          ${(t.savedFiles||[]).length?`<section class="saved-file-list">
                <strong>附件记录</strong>
                ${t.savedFiles.map(d=>`<span><b>${h(d.name)}</b><small>${h(d.sizeLabel||"")}</small></span>`).join("")}
              </section>`:""}
      ...
      <div class="login-handoff-wrap">
        <section class="login-handoff-card" aria-labelledby="login-handoff-title">
          ...
          <p class="login-handoff-domain">${h(F(t.url))}</p>
        </section>
      </div>`:`
      <div class="reader-frame-wrap">
    ...
    </header>`}function Xe(){const t=f.reports.filter(i=>i.archived).filter(i=>{if(!T.trim())return!0;const a=T.trim().toLowerCase();return`${i.title} ${i.url} ${i.source||""}`.toLowerCase().includes(a)}).sort((i,a)=>new Date(a.archivedAt||0)-new Date(i.archivedAt||0)),e=f.reports.filter(i=>i.archived).length;return`
    <main class="app-shell archive-shell">
      ...
      ${At()}
    </main>`}function Qe(){if(N)return Xe();const t=T.trim().toLowerCase(),e=t.split(/\s+/).filter(Boolean),i=f.reports.filter(l=>!l.archived),a=e.length?i.filter(l=>{const p=`${l.title} ${l.source||""} ${l.access||""} ${gt(l.workType)} ${(l.tags||[]).join(" ")}`.toLowerCase();return e.every(u=>p.includes(u))}):i,r=f.reports.filter(l=>l.archived).length,n=i.filter(l=>l.access==="production").length,c=i.filter(l=>l.access!=="production").length,s=ze(a,t).filter(l=>l.reports.length||D),d=S==="type"?"工作类型":S==="tag"?"关键标签":"工作主题";return`
    <main class="app-shell">
          ...
          ${s.length?`
            <div class="library-layout">
              <nav class="topic-nav" aria-label="报告${d}">
                ${s.map((l,p)=>`<a href="#bucket-${p}"><span class="nav-index">${String(p+1).padStart(2,"0")}</span>${h(l.name)}<span>${l.reports.length}</span></a>`).join("")}
              ...
              ${s.map((l,p)=>`
                <section id="bucket-${p}" class="group-column topic-section bucket-${h(l.kind)} accent-${h(l.accent||"blue")}"
                  data-bucket-kind="${h(l.kind)}"
                  data-bucket-id="${h(l.id)}"
                  ${l.kind==="topic"?`data-group-id="${h(l.id)}"`:""}>
                  <header class="group-header">
                    ${l.kind==="topic"?`<span class="group-drag-handle" role="button" tabindex="0" data-group-drag-id="${h(l.id)}"
                          aria-label="拖动“${h(l.name)}”调整主题顺序" title="拖动调整主题顺序；也可用左右方向键">
                          <span aria-hidden="true">⠿</span>
                    ...
                    <div class="group-heading-copy">
                      <div><h2>${h(l.name)}</h2></div>
                      <span class="count">${l.reports.length} 份</span>
                    </div>
                    <div class="group-menu">
                      ${D?`<button class="move-here-button" type="button" data-action="move-here" data-id="${h(l.id)}" data-bucket-kind="${h(l.kind)}">移到这里</button>`:""}
                      ${l.kind==="topic"?`<button type="button" data-action="add-to-group" data-id="${h(l.id)}">添加报告</button>
                           <button type="button" data-action="rename-group" data-id="${h(l.id)}">编辑主题</button>
                           ${l.id!=="inbox"?`<button type="button" data-action="delete-group" data-id="${h(l.id)}">删除</button>`:""}`:""}
                    </div>
                  </header>
                  <div class="group-cards">
                    ${l.reports.length?l.reports.map(u=>ee(u)).join(""):l.kind==="topic"?`<button class="empty-topic-drop" type="button" data-action="add-to-group" data-id="${h(l.id)}">
      ...
      ${At()}
    </main>`}function v(){const t=document.getElementById("app");if(sessionStorage.getItem(kt)!=="ok"){t.innerHTML=Ye(),ta();return}const e=M&&f.reports.find(i=>i.id===M);t.innerHTML=e?Je(e):Qe(),aa(),de({render:v,showToast:A,saveToLibrary:Ze})}function ta(){const t=document.getElementById("login-form");t==null||t.addEventListener("submit",e=>{if(e.preventDefault(),new FormData(t).get("password")!=="2026"){const a=t.querySelector(".form-error");a.hidden=!1,a.textContent="口令不正确，请再试一次";return}sessionStorage.setItem(kt,"ok"),v()})}async function ea(t){const e=t.elements.url,i=t.elements.title,a=t.querySelector('[data-action="detect-title"]'),r=t.querySelector(".field-hint"),n=e.value.trim();if(!rt(n))return r.textContent="请输入完整的 http 或 https 网址","";a.disabled=!0,a.innerHTML='<span class="mini-spinner"></span>',r.textContent="正在读取网页标题…";try{const{title:c}=await Jt(n);if(!c)throw new Error("read failed");return i.value=c,r.textContent="已识别网页标题",i.value}catch{const c=F(n);return i.value||(i.value=c),r.textContent="网页暂时无法读取，已用域名作为标题，你可以手动修改",i.value}finally{a.disabled=!1,a.textContent="识别标题"}}function aa(){var r;(r=document.getElementById("search-input"))==null||r.addEventListener("input",n=>{T=n.target.value,v();const c=document.getElementById("search-input");c==null||c.focus(),c==null||c.setSelectionRange(T.length,T.length)}),document.querySelectorAll("[data-action]").forEach(n=>{n.addEventListener("click",async c=>{var l,p;const s=c.currentTarget.dataset.action,d=c.currentTarget.dataset.id;if(s==="open")M=d,v();else if(s==="edit-document"){const u=f.reports.find(m=>m.id===d);if(!u||u.access!=="production")return;De(u,{render:v,showToast:A})}else if(s==="download-report"){const u=f.reports.find(m=>m.id===d);if(!u)return;Qt(u)?Ve(u)&&A("HTML 已下载"):await zt(u,A)}else if(s==="share-report"||s==="copy-production-url"){const u=f.reports.find(m=>m.id===d);u!=null&&u.url&&await Oe(u,m=>{A(m==="报告链接已复制"?"生产 URL 已复制":m)})}else if(s==="open-browser"){const u=f.reports.find(m=>m.id===d);if(!u)return;We(u)||A("浏览器未能打开该报告")}else if(s==="back")M="",$=null,v();else if(s==="lock")sessionStorage.removeItem(kt),v();else if(s==="clear-search")T="",v();else if(s==="set-view"){if(!["topic","type","tag"].includes(d))return;S=d,D="",localStorage.setItem(X,S),v()}else if(s==="cancel-move")D="",v();else if(s==="move-here"){const u=c.currentTarget.dataset.bucketKind||S;D&&_(D,u,d)&&(D="",v(),A(u==="tag"?"已添加目标标签":`报告已移入目标${j()}`))}else if(s==="show-archive")N=!0,T="",M="",v();else if(s==="show-catalog")N=!1,T="",M="",v();else if(s==="add-report")$={type:"report",mode:"create",groupId:((l=f.groups[1])==null?void 0:l.id)||((p=f.groups[0])==null?void 0:p.id)},v();else if(s==="add-to-group")$={type:"report",mode:"create",groupId:d},v();else if(s==="edit")$={type:"report",mode:"edit",reportId:d},v();else if(s==="edit-tags")$={type:"tags",reportId:d},v();else if(s==="close-modal")$=null,v();else if(s==="detect-title")await ea(c.currentTarget.closest("form"));else if(s==="archive"){const u=f.reports.find(m=>m.id===d);if(!u)return;u.archived=!0,u.archivedAt=new Date().toISOString(),L(),v(),A("已归档，可随时恢复")}else if(s==="restore"){const u=f.reports.find(m=>m.id===d);if(!u)return;u.archived=!1,u.archivedAt="",L(),v(),A("报告已恢复到原主题")}else if(s==="delete"){const u=f.reports.find(m=>m.id===d);u!=null&&u.archived&&confirm(`二次确认：永久删除“${u.title}”？

删除后无法从归档区恢复。`)&&(f.reports=f.reports.filter(m=>m.id!==d),M===d&&(M=""),L(),v(),A("报告已永久删除"))}else if(s==="add-group")$={type:"group",mode:"create"},v();else if(s==="rename-group")f.groups.find(m=>m.id===d)&&($={type:"group",mode:"edit",groupId:d},v());else if(s==="delete-group"){const u=f.groups.find(m=>m.id===d);u&&confirm(`删除“${u.name}”？其中的报告会移到“待整理”。`)&&(f.reports.forEach(m=>{m.groupId===d&&(m.groupId="inbox")}),f.groups=f.groups.filter(m=>m.id!==d),L(),v(),A("分组已删除，报告已移到待整理"))}})}),document.querySelectorAll(".report-drag-handle").forEach(n=>{let c=null,s=!1;const d=()=>{var l;C="",c=null,s=!1,(l=n.closest(".report-card"))==null||l.classList.remove("is-dragging"),document.querySelectorAll(".report-card, .group-column").forEach(p=>{p.classList.remove("is-card-drop-target","is-drop-ready")})};n.addEventListener("pointerdown",l=>{var p,u;l.preventDefault(),C=n.dataset.reportDragId,x="",c={x:l.clientX,y:l.clientY},s=!1,(p=n.setPointerCapture)==null||p.call(n,l.pointerId),(u=n.closest(".report-card"))==null||u.classList.add("is-dragging")}),n.addEventListener("pointermove",l=>{if(!C||c&&Math.hypot(l.clientX-c.x,l.clientY-c.y)<7)return;s=!0;const p=document.elementFromPoint(l.clientX,l.clientY),u=p==null?void 0:p.closest(".report-card"),m=p==null?void 0:p.closest(".group-column");document.querySelectorAll(".report-card").forEach(y=>{y.classList.toggle("is-card-drop-target",!!(u&&u!==n.closest(".report-card")&&y===u))}),document.querySelectorAll(".group-column").forEach(y=>{y.classList.toggle("is-drop-ready",!!(m&&y===m))})}),n.addEventListener("pointerup",l=>{if(!C)return;const p=C;if(!s){D=p,d(),v(),A(`请选择目标${j()}`);return}const u=document.elementFromPoint(l.clientX,l.clientY),m=u==null?void 0:u.closest(".report-card"),y=u==null?void 0:u.closest(".group-column"),k=(m==null?void 0:m.dataset.reportId)||"",g=(y==null?void 0:y.dataset.bucketId)||"",w=(y==null?void 0:y.dataset.bucketKind)||S,b=k&&k!==p?_(p,w,g,k):g?_(p,w,g):!1;d(),b&&(v(),A(w==="tag"?"已添加目标标签":w==="type"?"工作类型已更新":k?"报告顺序已更新":"已移入新主题"))}),n.addEventListener("pointercancel",d)}),document.querySelectorAll(".group-drag-handle").forEach(n=>{const c=()=>{var s;x="",(s=n.closest(".group-column"))==null||s.classList.remove("is-group-dragging"),document.querySelectorAll(".group-column").forEach(d=>{d.classList.remove("is-group-drop-target","is-drop-ready")})};n.addEventListener("pointerdown",s=>{var d,l;s.preventDefault(),x=n.dataset.groupDragId,C="",(d=n.setPointerCapture)==null||d.call(n,s.pointerId),(l=n.closest(".group-column"))==null||l.classList.add("is-group-dragging")}),n.addEventListener("pointermove",s=>{x&&document.querySelectorAll(".group-column").forEach(d=>{var l;d.classList.toggle("is-group-drop-target",d===((l=document.elementFromPoint(s.clientX,s.clientY))==null?void 0:l.closest(".group-column")))})}),n.addEventListener("pointerup",s=>{var p;if(!x)return;const d=x,l=(p=document.elementFromPoint(s.clientX,s.clientY))==null?void 0:p.closest(".group-column");if(l&&ct(d,l.dataset.groupId)){x="",v(),A("分组顺序已更新");return}c()}),n.addEventListener("pointercancel",c),n.addEventListener("keydown",s=>{var u;if(!["ArrowLeft","ArrowRight"].includes(s.key))return;s.preventDefault();const d=f.groups.findIndex(m=>m.id===n.dataset.groupDragId),l=s.key==="ArrowLeft"?d-1:d+1,p=f.groups[l];!p||!ct(n.dataset.groupDragId,p.id)||(v(),A("分组顺序已更新"),(u=document.querySelector(`[data-group-drag-id="${CSS.escape(n.dataset.groupDragId)}"]`))==null||u.focus())})}),document.querySelectorAll(".group-column").forEach(n=>{n.addEventListener("dragover",c=>{c.preventDefault(),n.classList.add(x?"is-group-drop-target":"is-drop-ready")}),n.addEventListener("dragleave",()=>{n.classList.remove("is-drop-ready","is-group-drop-target")}),n.addEventListener("drop",c=>{if(c.preventDefault(),x){if(n.dataset.bucketKind==="topic"&&ct(x,n.dataset.groupId)){x="",v(),A("分组顺序已更新");return}x="",n.classList.remove("is-group-drop-target");return}const s=f.reports.find(l=>l.id===C),d=n.dataset.bucketKind||S;s&&_(C,d,n.dataset.bucketId)&&(C="",v(),A(d==="tag"?"已添加目标标签":d==="type"?"工作类型已更新":"已移入新主题")),C=""})}),document.querySelectorAll("[data-tag-suggestion]").forEach(n=>{n.addEventListener("click",()=>{const c=document.querySelector('#tag-form input[name="tags"]');if(!c)return;const s=lt(c.value),d=n.dataset.tagSuggestion;c.value=s.includes(d)?s.filter(l=>l!==d).join("、"):[...s,d].slice(0,8).join("、"),n.classList.toggle("selected",!s.includes(d)),c.focus()})});const t=document.getElementById("tag-form");t==null||t.addEventListener("submit",n=>{n.preventDefault();const c=f.reports.find(s=>s.id===$.reportId);c&&(c.tags=lt(new FormData(t).get("tags")),L(),$=null,v(),A("标签已更新"))});const e=document.getElementById("group-form");e==null||e.addEventListener("submit",n=>{var l,p;n.preventDefault();const c=(l=new FormData(e).get("name"))==null?void 0:l.trim(),s=(p=new FormData(e).get("description"))==null?void 0:p.trim();if(!c)return;if($.mode==="edit"){const u=f.groups.find(m=>m.id===$.groupId);if(!u)return;u.name=c.slice(0,60),u.description=(s==null?void 0:s.slice(0,80))||"自定义工作主题"}else f.groups.push({id:ht("group"),name:c.slice(0,60),description:(s==null?void 0:s.slice(0,80))||"自定义工作主题",accent:["blue","violet","amber","green"][f.groups.length%4],position:f.groups.length});L();const d=$.mode==="edit"?"工作主题已更新":"工作主题已创建，可直接拖入报告";$=null,v(),A(d)});const i=document.getElementById("report-form");i==null||i.addEventListener("submit",async n=>{n.preventDefault();const c=i.elements.url.value.trim();if(!rt(c))return;const s=i.querySelector('button[type="submit"]'),d=i.querySelector(".field-hint");s.disabled=!0,s.innerHTML='<span class="mini-spinner"></span>';const l=$.mode==="edit"?$.reportId:"",p=Vt({material:c,files:[],url:c,excludeId:l});if(p){s.disabled=!1,s.textContent="保存",d.textContent=`成果库已有“${p.title}”，未重复保存`,A(`成果库已有“${p.title}”，未重复保存`);return}const u=await Xt({material:c,files:[],url:c},E=>{d.textContent=E});if(!u.allowed){s.disabled=!1,s.textContent="保存",d.textContent=u.reason,A(u.reason);return}let m=i.elements.title.value.trim()||u.metadata.title;const y=i.elements.groupId.value,k=i.elements.workType.value,g=lt(i.elements.tags.value),w={title:m||F(c),url:c,groupId:y,workType:k,source:"手动添加",access:u.access,detectedDescription:u.metadata.description,manualSaved:!0,isProduction:u.access==="production",isPersonal:Wt(c),isHtml:u.isHtml,loginProvider:u.loginProvider},b=[...new Set([...at(w,k),...g])].slice(0,8);if($.mode==="edit"){const E=f.reports.find(R=>R.id===$.reportId);Object.assign(E,w,{tags:b})}else{const E={id:ht("report"),groupId:y,...w,pinned:!1,position:f.reports.filter(R=>R.groupId===y).length,createdAt:new Date().toISOString(),archived:!1,archivedAt:"",tags:b};f.reports.push(E)}L(),$=null,v(),A("报告已保存")});const a=M&&f.reports.find(n=>n.id===M);a&&Re(a)}function ia(){v()}ia(document.getElementById("app"));
