...
| 截图 | 场景 | 公开处理 |
|---|---|---|
| 资产分析卡 | 看懂持仓分布与集中度 | 个人资产标签与比例已脱敏 |
| 月度对账单卡 | 选择月份并进入账户凭证 | 个人资产金额已脱敏 |
| 指定月分析卡 | 月末资产、月度收益与报告入口 | 个人金额已脱敏 |
| 基金研究卡 | 比较收益、波动、回撤与性价比 | 公开基金信息原图 |
| 定制方案卡 | 按家庭、伴侣、教育等用途设目标 | 公开服务入口原图 |
| 人工服务卡 | AI 无法解决时转人工 | 生产界面原图 |
| 第三方会话结束 | 展示自动跳转造成的中断后果 | 生产界面原图 |
| 基金详情卡 | 单基金收益与风险下钻 | 公开基金信息原图 |
| 指数估值卡 | PE、百分位、走势与基金入口 | 公开市场信息原图 |
