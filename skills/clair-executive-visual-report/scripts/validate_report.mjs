...
if (htmlPath) {
  ...
  for (const [signal, message] of [
    ...
    ['height:108px', "HTML 缺少统一桌面标题带高度"],
    ['clamp(30px,2.6vw,36px)', "HTML 章节标题层级不足"],
    ['align-content:end', "HTML 副标与核心内容区间距过松"],
    ['grid-template-columns:minmax(0,760px)', "HTML 标题与副标未使用统一内容列宽"],
    ['-webkit-line-clamp:2', "HTML 缺少标题防遮挡行数约束"],
    ['margin:12px 0 0', "HTML 章节编号与标题间距不足"],
