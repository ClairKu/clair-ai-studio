...
- 申请用户 8,569 / 10,000 = 85.7% · 飞书源稿 P1 · revision 1978
...
累计调用 9.19M（OKR 70.7%）、申请用户 8,569（85.7%）、MAU 1,812（90.6%）；平台跨过能力验证期，下半场主线是规模放大与商化验证。关键举措遵循「盈米 AI 开放平台底座 → 四个持续 → 两类接入模式 → 更多群体」放大势能；业务调用 TOP20 进一步表明，真实需求从资讯与基金发现起步，再进入诊断、配置与策略服务，行业机会在于把头部入口编排成完整投顾任务链。
