...
report_cutoff: 2026-08-10（年度目标核心经营指标截至 21:11，为部分日数据）
...
- 累计调用 9,353,911 / 13,000,000 = 72.0%（年末正式 OKR；距目标 3,646,089 次）· 截至 2026-08-10 21:11 · OAP Stargate 后台同口径数据
- 申请用户 9,520 / 10,000 = 95.2%（距目标 480 人）· 截至 2026-08-10 21:11 · OAP Stargate 后台同口径数据
- MAU 2,155 / 2,000 = 107.8%（超目标 155 人）· 截至 2026-08-10 21:11 · OAP Stargate 后台同口径数据
...
累计调用 9.35M（OKR 72.0%）、申请用户 9,520（95.2%）、MAU 2,155（107.8%，已超年度目标）；平台跨过能力验证期，下半场主线是补足调用规模、放大新入口并验证商化。关键举措遵循「盈米 AI 开放平台底座 → 四个持续 → 两类接入模式 → 更多群体」放大势能；业务调用 TOP20 进一步表明，真实需求从资讯与基金发现起步，再进入诊断、配置与策略服务，行业机会在于把头部入口编排成完整投顾任务链。
